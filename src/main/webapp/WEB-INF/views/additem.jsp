    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <head>
                ...
                <link href="${pageContext.request.contextPath}/css/admin/lib/bootstrap/bootstrap.min.css"
                    rel="stylesheet">
                        ...
                        <nav class="navbar top-navbar navbar-expand-md navbar-light">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="dashboard.html">
                                    <span><svg width="206" height="50" viewBox="0 0 206 50" fill="none"
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle text-muted  " href="#" data-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false"><img
                                                src="${pageContext.request.contextPath}/images/admin/images/bookingSystem/user-icn.png"
                        ...
                        <div class="scroll-sidebar">
                            <nav class="sidebar-nav">
                                <ul id="sidebarnav">
                                    ...
                                    <li> <a href="${pageContext.request.contextPath}/admin/users"> <span><i
                                    ...
                                    <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery"
                                        ...
                                        <ul aria-expanded="false" class="collapse">
                                            <li><a href="${pageContext.request.contextPath}/admin/items">All Items</a>
                                            </li>
                                            <li><a href="${pageContext.request.contextPath}/admin/additem">Add Item</a>
                                            </li>
                                        </ul>
                                    </li>
                        ...
                        <div class="container-fluid">
                            <div class="col-lg-12">
                                <div class="card card-outline-primary">
                                    ...
                                    <div class="card-body">
                                        <form:form action="${pageContext.request.contextPath}/admin/additem"
                                                ...
                                                <div class="row p-t-20">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group has-danger">
                                                            ...
                                                            <input required="true" name="desc" type="text"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input required="true" type="number" name="discountedprice"
                                                                class="form-control" placeholder="0" />
