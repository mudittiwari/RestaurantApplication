            ...
            <div class="container-fluid">
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <form:form  action="${pageContext.request.contextPath}/admin/additem" method="post" enctype="multipart/form-data">
    <div class="form-body">
        <hr>
    ...
    <span class="error">${nameerror}</span>
            ...
            <div class="col-md-6">
                <div class="form-group has-danger">
                    ...
                    <input required="true" name="desc" type="text" class="form-control form-control-danger" />
        ...
        <div class="row p-t-20">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input required="true" type="number" name="price" class="form-control" placeholder="0" />
