...
<html lang="en">
  ...
  <body class="fix-header fix-sidebar">
            ...
            <ul id="sidebarnav">
              ...
              <li>
                ...
                <ul aria-expanded="false" class="collapse">
                  ...
                  <li>
                    <a href="${pageContext.request.contextPath}/admin/additem"
                      >Add Item</a
                    >
                  </li>
                </ul>
                            ...
                            <td>
                              ...
                              <c:choose>
                                <c:when test="${item.isFeatured()}">
                                  <a
                                    href="${pageContext.request.contextPath}/admin/removefeatured/${item.getId()}"
                                ...
                                <c:otherwise>
                                  <a
                                    href="${pageContext.request.contextPath}/admin/addfeatured/${item.getId()}"
                                    class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"
                                    >Add Featured</a
                                  >
                                </c:otherwise>
                              ...
                              <c:choose>
                                <c:when test="${item.isInStock()}">
                                  <a
                                    href="${pageContext.request.contextPath}/admin/removeinstock/${item.getId()}"
                                    class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"
                                    >Remove In Stock</a
                                  >
                                </c:when>
                                <c:otherwise>
                                  <a
                                    href="${pageContext.request.contextPath}/admin/addinstock/${item.getId()}"
                                    class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"
                                    >Add In Stock</a
                                  >
                                </c:otherwise>
                              ...
                              <a
                                href="${pageContext.request.contextPath}/admin/deleteitem/${item.getId()}"
    ...
    <script src="${pageContext.request.contextPath}/js/admin/lib/datatables/datatables.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/admin/lib/datatables/cdn.datatables.net/buttons/1.2.2/js/dataTables.buttons.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/admin/lib/datatables/cdn.datatables.net/buttons/1.2.2/js/buttons.flash.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/admin/lib/datatables/cdnjs.cloudflare.com/ajax/libs/jszip/2.5.0/jszip.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/admin/lib/datatables/cdn.rawgit.com/bpampuch/pdfmake/0.1.18/build/pdfmake.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/admin/lib/datatables/cdn.rawgit.com/bpampuch/pdfmake/0.1.18/build/vfs_fonts.js"></script>
    <script src="${pageContext.request.contextPath}/js/admin/lib/datatables/cdn.datatables.net/buttons/1.2.2/js/buttons.html5.min.js"></script>
    <script src="${pageContext.request.contextPath}/js/admin/lib/datatables/datatables-init.js"></script>
  </body>
</html>
