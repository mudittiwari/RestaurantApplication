    ...
    <div class="flex w-full justify-start">
      ...
      <div class="flex flex-col w-full justify-center">
        ...
        <div class="h-screen pt-20">
          <h1 class="mb-10 text-center text-2xl font-bold">Order History</h1>
          <div
          ...
          >
            <div class="rounded-lg w-full">
              ...
              >
                <div
                  class="swiper flex h-full w-full justify-center items-center"
                >
                  <div class="swiper-wrapper">
                    <c:forEach var="item" items="${order.items}">
                    <div class="swiper-slide">
                      <div
                        class="flex justify-between my-12 items-center sm:flex sm:justify-start w-2/3"
                      >
                        <img
                        ...
                        >
                          <div class="mt-5 sm:mt-0">
                            ...
                            <p class="mt-1 text-xs text-gray-700">${item.getCategory().getName()}</p>
                          </div>
                  ...
                  <div class="flex justify-between items-center w-full mt-3">
                    <p>Ordered on: <fmt:formatDate value="${order.getCreatedAt()}" pattern="yyyy-MM-dd" /></p>
                    <p>Order Status: ${order.getStatus()}</p>
                    <p>Total Amount: $${order.getTotalPrice()}</p>
                  </div>
