    ...
    <tbody>
        <c:forEach items="${users}" var="user">
            <tr>
                ...
                <td>${user.getAuthority().getAuthority()}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/admin/deleteuser/${user.getUsername()}" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5">Delete</a>
                </td>
            </tr>
        </c:forEach>
    </tbody>
