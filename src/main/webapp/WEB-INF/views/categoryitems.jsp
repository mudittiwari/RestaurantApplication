        ...
        <div class="flex w-full justify-start">
            ...
            <div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" @resize.window="watchScreen()">
              <div
                ...
                <div class="flex flex-shrink-0 transition-all">
                  <div x-show="isSidebarOpen" @click="isSidebarOpen = false" class="fixed inset-0 z-10 lg:hidden"></div>
                  <!-- Mobile bottom bar -->
                  ...
                  <nav aria-label="Options"
                    ...
                    <div class="flex flex-col items-center flex-1 p-2 space-y-4 top-0 fixed">
                      <!-- Menu button -->
                      <button
                        @click="(isSidebarOpen && currentSidebarTab == 'linksTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'linksTab'"
                        class="p-2 transition-colors rounded-lg shadow-md hover:bg-yellow-400 hover:text-white focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-white focus:ring-offset-2"
                  ...
                  <div id="rightnavbar" x-transition:enter="transform transition-transform duration-300"
                    ...
                    <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
                      ...
                      <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
                        <div>
                          <div class="flex flex-col items-start h-screen bg-white rounded-l-2xl w-2/5">
                            <img src="${pageContext.request.contextPath}/images/resources/logo-dona.png"
          ...
          <div class="flex flex-col w-full h-full">
            ...
            <div class="flex w-full">
              <div
                class="button-container overflow-x-scroll flex justify-start w-full mt-5 sm:mt-0 md:mt-0 lg:mt-0 xl:mt-0">
              ...
              <div class="swiper mt-24 w-5/6">
                    ...
                    <div class="swiper-slide">
                      <div class="w-full flex flex-wrap justify-center gap-1">
                        ...
                        <div class="w-full flex justify-center flex-col items-center">
                          <div
                            class="w-full text-center flex productTitle text-3xl justify-center items-center mt-2 sm:mt-0 md:mt-0 lg:mt-0 xl:mt-0">
                            <h2>${item.getName()}</h2>
                          </div>
                          <div class="w-full overflow-hidden flex justify-center items-center">
                            <img style="height: 200px; width: 200px;"
                              class="w-1/2 mt-5 object-fill rounded-full hover:scale-110"
                          ...
                          <div class="flex w-full justify-center items-center mt-2 productIngredients">
                            <ul class="flex w-full justify-center gap-2">
                              <li><img src="${pageContext.request.contextPath}/images/resources/onion.png"
                                  class="w-10 h-10 object-contain" alt=""></li>
                              <li><img src="${pageContext.request.contextPath}/images/resources/gajar.png"
                                  class="w-10 h-10 object-contain" alt=""></li>
                              <li><img src="${pageContext.request.contextPath}/images/resources/mirch.png"
                                  class="w-10 h-10 object-contain" alt=""></li>
                              <li><img src="${pageContext.request.contextPath}/images/resources/meat.png"
                                  class="w-10 h-10 object-contain" alt=""></li>
                            </ul>
                          </div>
                ...
                <div class="swiper-button-prev cursor-pointer z-10"></div>
                <div class="swiper-button-next cursor-pointer z-10"></div>
              </div>
            </div>
          </div>
          ...
          <div class="flex justify-end right-0" id="rightnavbar">
            <div x-data="setup2()" x-init="$refs.loading.classList.add('hidden');" @resize.window="watchScreen()">
              <div
                ...
                <div class="flex flex-shrink-0 transition-all right-0 justify-end">
                  ...
                  <nav aria-label="Options"
                    ...
                    <div class="flex gap-7 items-center">
                      <a class="flex gap-7" href="${pageContext.request.contextPath}/favourite">
                        <img src="${pageContext.request.contextPath}/images/resources/fav-icon.png"
                          href="${pageContext.request.contextPath}/favourite" class="w-7 h-6 mt-1" />
                      </a>
                      <button
                        @click="(isSidebarOpen && currentSidebarTab == 'linksTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'linksTab'"
                  ...
                  <nav aria-label="Options"
                    ...
                    <div class="flex items-center gap-4 top-0">
                      ...
                      <a class="flex gap-7" href="${pageContext.request.contextPath}/favourite">
                        <img src="${pageContext.request.contextPath}/images/resources/fav-icon.png"
                          class="p-2 transition-colors right-0 rounded-lg hover:bg-yellow-400 hover:text-white focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-white focus:ring-offset-2" /></a>
                      <button
                        @click="(isSidebarOpen && currentSidebarTab == 'linksTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'linksTab'"
                  ...
                  <div x-transition:enter="transition-transform transition-opacity ease-in-out duration-300"
                    x-transition:enter-start="transform translate-x-full opacity-0"
                    x-transition:enter-end="transform translate-x-0 opacity-100"
                    x-transition:leave="transition-transform transition-opacity ease-in-out duration-300"
                    x-transition:leave-start="transform translate-x-0 opacity-100"
                    x-transition:leave-end="transform translate-x-full opacity-0" x-show="isSidebarOpen"
                    ...
                    <nav x-show="currentSidebarTab == 'linksTab'" aria-label="Main" class="flex flex-col h-full">
                      <div class="flex-1 px-4 space-y-2 overflow-hidden hover:overflow-auto">
                        <div>
                          ...
                          <div class="w-full flex flex-col items-start h-screen bg-white rounded-l-2xl w-2/5">
                            <div class="flex w-full">
                              <div class="w-full">
                                <!-- component -->
                                    ...
                                    <div class="flex h-64 justify-center">
                                      <div class="relative">
                                        <div class="flex flex-row cursor-pointer truncate p-2 px-4 rounded">
                                          <div class="flex flex-row-reverse ml-20 w-full">
                                            ...
                                            <div class="flex justify-center flex-col mt-5">
                                              ...
                                              <div class="p-4 justify-center flex">
                                                <form action="${pageContext.request.contextPath}/addorder">
                                                  <select name="tableNumber" class="w-full h-8">
                                                    <c:forEach begin="1" end="10" varStatus="loop">
                                                      <option value="${loop.index}" <c:if test="${loop.index == 1}">
                                                        selected
                                </c:if>
                                >${loop.index}</option>
                                </c:forEach>
                                ...
                                <input type="password" placeholder="Please Enter Password"
                                  class="p-2 password-input mt-2" name="password">
                                <button type="submit"
