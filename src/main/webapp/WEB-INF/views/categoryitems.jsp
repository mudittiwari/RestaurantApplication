      ...
      <div class="flex flex-col w-3/4 mx-auto h-full">
        ...
        <div class="flex flex-wrap h-screen">
          <div class="button-container" id="buttonContainer">
            <button class="button active" id="starterButton">Starter</button>
            <button class="button" id="meatButton">Meat</button>
            <button class="button" id="fishButton">Fish</button>
            <button class="button" id="dessertsButton">Desserts</button>
            <span class="border-highlight" id="borderHighlight"></span>
            <!-- Border highlight element -->
          </div>

          <!-- Select Product -->
          <div class="swiper mt-14">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="w-full px-1 flex flex-wrap justify-center gap-1">
                  <!-- Product Card -->
                  <div class="w-2/4 flex justify-center flex-col align-center">
                    <div
                      class="flex productTitle text-3xl justify-center items-center absolute top-28 left-1/2 transform -translate-x-1/2 translate-y-1/4"
                    >
                      <h2>PIZZA</h2>
                    </div>
                    <div
                    ...
                    >
                      <img
                        class="w-full object-fill rounded-full hover:scale-110 transform transition duration-500 ease-in-out cursor-pointer"
                        src="https://imgs.search.brave.com/OLgQjDxjNz2XzNcJx5awnTcP8oxvBmq3-_GJ35SABCk/rs:fit:500:0:0/g:ce/aHR0cHM6Ly93d3cu/cG5nbWFydC5jb20v/ZmlsZXMvMS9QZXBw/ZXJvbmktUGl6emEu/cG5n"
                        alt="Product Image"
                      />
                    </div>
                    <div
              class="flex justify-center items-center absolute top-2/4 left-1/2 transform -translate-x-1/2 translate-y-3/4 flex-col gap-2 text-center"
            >
              <p class="text-sm">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
              </p>
              <p class="text-2xl productTitle">300$</p>
            </div>
            <div class="flex flex-col justify-center relative bottom-40 left-0">
              ...
              <div class="flex justify-center">
                <button
                  class="bg-yellow-400 text-white w-40 p-2 text-center rounded-3xl mt-2"
                >
                  Add to Cart >>
                </button>
              </div>
              ...
              <div class="swiper-slide">
                <div class="w-full px-1 flex flex-wrap justify-center gap-1">
                  ...
                  <div class="w-2/4 flex justify-center flex-col align-center">
                    ...
                    >
                      <img
                        class="w-full object-fill rounded-3xl hover:scale-110 transform transition duration-500 ease-in-out cursor-pointer"
                        src="https://imgs.search.brave.com/OLgQjDxjNz2XzNcJx5awnTcP8oxvBmq3-_GJ35SABCk/rs:fit:500:0:0/g:ce/aHR0cHM6Ly93d3cu/cG5nbWFydC5jb20v/ZmlsZXMvMS9QZXBw/ZXJvbmktUGl6emEu/cG5n"
                        alt="Product Image"
                      />
                    </div>
            ...
            <div class="flex flex-shrink-0 transition-all right-0 justify-end">
              ...
              >
                ...
                <div class="flex gap-7 items-center">
                  <img src="resources/fav-icon.png" class="w-7 h-6 mt-1" />
                  <button
                    @click="(isSidebarOpen && currentSidebarTab == 'linksTab') ? isSidebarOpen = false : isSidebarOpen = true; currentSidebarTab = 'linksTab'"
                  ...
                  >
                    <img src="resources/orders.png" class="w-7 h-7" />
                  </button>
                </div>
              </nav>
              <!-- Left mini bar -->
