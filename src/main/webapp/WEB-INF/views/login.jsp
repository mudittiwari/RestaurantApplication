  ...
  <body>
    ...
    <div class="container">
      <div class="bg-setup">
        ...
        />
        <img
          src="${pageContext.request.contextPath}/images/login/Ellipse 44.png"
          alt=""
        />
        <img
          src="${pageContext.request.contextPath}/images/login/Ellipse 45.png"
          alt=""
        />
        <img
          src="${pageContext.request.contextPath}/images/login/vawe (2).png"
          alt=""
        />
        <img
          src="${pageContext.request.contextPath}/images/login/vawe (3).png"
          alt=""
        />
        <img
          src="${pageContext.request.contextPath}/images/login/Oval Copy.png"
          alt=""
        />
        <div class="login-form">
          ...
          <form class="form-container" action="${loginUrl}" method="post">
            ...
            <a href="${pageContext.request.contextPath}/signup" class="signup"
