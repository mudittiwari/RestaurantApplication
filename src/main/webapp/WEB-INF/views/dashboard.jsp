...
<body class="fix-header">
            ...
            <div class="container-fluid">
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="card p-30" style="background-color: rgb(42, 0, 118);">
                                    <div class="media">
  ...
  const firebaseConfig = {
    apiKey: "AIzaSyDwHWmmWcydJ4PiNv7c9wpTXDyypSzbtRI",
    authDomain: "restaurantwebsite-bc41a.firebaseapp.com",
    projectId: "restaurantwebsite-bc41a",
    storageBucket: "restaurantwebsite-bc41a.appspot.com",
    messagingSenderId: "193527555232",
    appId: "1:193527555232:web:c05f46caa6576d5ed795c5"
  };
