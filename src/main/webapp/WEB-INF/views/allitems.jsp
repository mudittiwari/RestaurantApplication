  ...
  <body class="bg-gray-100 rounded-3xl p-1 bg-Image">
    <div class="flex w-full justify-start">
      ...
      <div class="flex flex-col w-full">
        <div class="w-full ml-20 text-2xl font-bold my-16 titleColor">
          Chinese
        </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="w-full flex flex-wrap justify-center gap-12">
                  <!-- Product Card -->
                  <div
                    class="mt-16 w-1/5 bg-white overflow-hidden border border-yellow-100 rounded-2xl flex justify-center flex-col items-center"
                  >
                    <img
                      class="w-full h-44 object-fill hover:scale-110 transform transition duration-500 ease-in-out cursor-pointer"
                      src="https://imgs.search.brave.com/raN0RTMnsczIkJMvBwboNJq5tcnxqBhPR2h6Kjighkc/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9zdC5k/ZXBvc2l0cGhvdG9z/LmNvbS8xMDAzODE0/LzUwNTIvaS80NTAv/ZGVwb3NpdHBob3Rv/c181MDUyMjc2NS1z/dG9jay1waG90by1w/aXp6YS13aXRoLXRv/bWF0b2VzLmpwZw"
                      alt="Product Image"
                    />
                      ...
                      <div class="flex justify-between gap-4">
                        ...
                        >
                          <span class="text-sm font-semibold titleColor"
                            >Category</span
                          >
                          <span class="text-sm textColor">Chinese</span>
                        </div>
                        <div
                          class="mt-4 flex flex-col justify-center items-center"
                        >
                          <span class="text-sm font-semibold titleColor"
                            >Price</span
                          >
                          <span class="text-sm textColor font-bold">$10</span>
                        </div>
                      </div>
                    </div>
                    <div class="pt-2 pb-4 w-full flex justify-between text-sm">
                      <div
                        class="btnBg text-white font-bold py-2 m-2 rounded-2xl px-4"
                      >
                        In Stock
                      </div>
                      <button
                  ...
                  >
                    <img
                      class="w-full h-44 object-fill hover:scale-110 transform transition duration-500 ease-in-out cursor-pointer"
                      src="https://imgs.search.brave.com/mPzFjr6OBgSEcr7g33zKc6st6cNjxqj3T8uxOlnuCWM/rs:fit:860:0:0/g:ce/aHR0cHM6Ly9zdDMu/ZGVwb3NpdHBob3Rv/cy5jb20vNTAxOTAw/OS8xNTE2MC9pLzQ1/MC9kZXBvc2l0cGhv/dG9zXzE1MTYwNzk3/Mi1zdG9jay1waG90/by1uZXBhbGVzZS10/cmFkaXRpb25hbC1k/dW1wbGluZy1tb21v/cy1zZXJ2ZWQuanBn"
                      alt="Product Image"
                    />
                    <div class="font-bold text-xl mt-5 titleColor">
                      Product Name
              ...
              <div class="swiper-slide">
                <div class="w-full w-full flex flex-wrap justify-center gap-12">
                  <!-- Product Card -->
                  <div
                    class="mt-16 w-1/5 bg-white overflow-hidden border border-yellow-100 rounded-2xl flex justify-center flex-col items-center"
                  >
